...
public class SandboxArreglos
{
    ...
    public void agregarEntero( int entero )
    {
    	...
    	nuevoEntero[arregloEnteros.length] = entero;
    ...
    public void agregarCadena( String cadena )
    {
    	...
    	nuevaCadena[arregloCadenas.length] = cadena;
    ...
    {
    	int [] agregarEntero = new int[arregloEnteros.length + 1];
    	
    	if(posicion < 0) {
    		agregarEntero[0] = entero;
    		for (int i = posicion; i < arregloEnteros.length; i++) {
        		agregarEntero[i + 1] = arregloEnteros[i] ;
        	}
    	}
    	else if (posicion > arregloEnteros.length) {
    		for(int i = 0; i < arregloEnteros.length; i++)
        	{
        		agregarEntero[i] = arregloEnteros[i];
        	}
    	}
    	agregarEntero[arregloEnteros.length] = entero;
    	...
    	agregarEntero[posicion] = entero;
    	
    	for (int i = posicion; i < arregloEnteros.length; i++) {
    		agregarEntero[i + 1] = arregloEnteros[i] ;
    	}
    	arregloEnteros = agregarEntero;
    }
    ...
    public void eliminarEnteroPorPosicion( int posicion )
    {
    	...
    	if (posicion >= 0 && posicion < arregloEnteros.length) {
    		int[] arregloSinPosicion = new int [arregloEnteros.length - 1];
    		
    		for (int i = 0; i < arregloEnteros.length; i++) {
    			if (i != posicion) {
    				arregloSinPosicion[contador] = arregloEnteros[i];
    				contador++;
    			}
    		}
    		arregloEnteros = arregloSinPosicion;
    	}
    ...
    public void reiniciarArregloEnteros( double[] valores )
    {
    	...
    	for(double i = 0; i < valores.length; i++) {
    		arregloEnteros[(int) i] = (int)Math.floor(valores[(int )i]);
    	}
    }
